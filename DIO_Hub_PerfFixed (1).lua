        ...
        if _G.Auto_Cake_Prince then
            pcall(function()
                ...
                for _, mob in ipairs(enemies:GetChildren()) do
                    if table.find(CAKE_MOBS, mob.Name) and mob:FindFirstChild("Humanoid") and mob.Humanoid.Health > 0
                ...
                if bestMob then
                    ...
                    repeat
                        ...
                        local mirrorOk = pcall(function()
                            return workspace.Map.CakeLoaf.BigMirror.Other.Transparency == 0
                        end)
                        local portalNow = mirrorOk and (workspace.Map.CakeLoaf.BigMirror.Other.Transparency == 0)
